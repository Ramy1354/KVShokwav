    ...
    try {
      ...
      if (amount > economy.bank) {
        const insufficientEmbed = new EmbedBuilder()
          ...
          .setDescription(`You don't have **${amount.toLocaleString()} coins** in your bank!\nYour bank balance: **${economy.bank.toLocaleString()} coins**`)
          .setTimestamp();
      ...
      if (updateError) {
        const errorEmbed = new EmbedBuilder()
          .setColor('#FF6B6B')
          .setTitle('❌ Error')
          .setDescription(`Failed to withdraw money: ${updateError.message}`)
          .setTimestamp();
